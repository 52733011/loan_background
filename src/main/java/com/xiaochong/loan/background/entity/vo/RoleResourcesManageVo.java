...
@ApiModel
public class RoleResourcesManageVo {
    ...
    private List<RoleResourcesManageVo> sonResources;
    ...
    public List<RoleResourcesManageVo> getSonResources() {
        return sonResources;
    }

    public void setSonResources(List<RoleResourcesManageVo> sonResources) {
